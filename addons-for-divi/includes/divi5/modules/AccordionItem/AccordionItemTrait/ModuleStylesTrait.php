<?php
/**
 * AccordionItem: Module styles trait.
 *
...
trait ModuleStylesTrait
{
     ...
     *
     * The title/content typography is controlled by the parent Accordion; the
     * child only emits its own module decoration styles plus any custom CSS.
     *
    ...
    public static function module_styles($args)
    {
        ...
        $all_styles = [
            ...
            $elements->style(['attrName' => 'readMore']),
        ];
